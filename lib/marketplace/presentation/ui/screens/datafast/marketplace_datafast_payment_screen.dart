...
class MarketplaceDatafastPaymentScreen extends StatefulWidget {
  const MarketplaceDatafastPaymentScreen({
    super.key,
    required this.total,
  ...
  @override
  State<MarketplaceDatafastPaymentScreen> createState() =>
      _MarketplaceDatafastPaymentScreenState();
}
...
class _MarketplaceDatafastPaymentScreenState
  ...
  void initState() {
    super.initState();
    final base = MarketplaceConstants.datafastApiUrl.endsWith('/')
        ? MarketplaceConstants.datafastApiUrl
        : '${MarketplaceConstants.datafastApiUrl}/';
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onNavigationRequest: (request) {
            ...
            const resultPrefix =
                '${MarketplaceConstants.apiUrl}/pasarela/result/';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: FittedBox(
          child: Text(
            'Total a pagar',
            style: MarketplaceTheme.titleLargeTextStyle(context),
          ),
        ),
        actions: [
          Padding(
